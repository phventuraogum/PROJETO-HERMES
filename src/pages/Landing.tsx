...
import {
  ...
  Lock, User, Building2, Loader2, QrCode, CreditCard, ChevronRight,
...
type Plan = { name: string; label: string; price: number; searches: number; enrichments: number; exports: number };

// Mantemos apenas o plano grátis na LP (sem exibir preços/planos pagos).
const PLANS: Plan[] = [
  { name: "free", label: "Grátis", price: 0, searches: 50, enrichments: 15, exports: 5 },
];
...
const COMPARISONS = [
  { name: "Plataforma A", searches: "300/mês", crm: true, ia: false, pipeline: false },
  { name: "Plataforma B", searches: "Variável", crm: true, ia: false, pipeline: false },
  { name: "Plataforma C", searches: "Ilimitado", crm: true, ia: true, pipeline: false },
  { name: "Hermes", searches: "500/mês", crm: true, ia: true, pipeline: true },
];
      ...
      <section className="relative pt-16 pb-8 md:pt-24 md:pb-12 overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 max-w-5xl text-center">
          ...
          <FadeIn delay={300}>
            ...
            <p className="mt-3 text-[11px] text-muted-foreground/40">Acesse sua conta para continuar.</p>
          </FadeIn>
        </div>
